...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(900, 1024), (1520, 1520)], keep_ratio=True),
    # dict(type='Resize', img_scale=[(1000, 1124), (1520, 1520)], keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        # 多尺度test 无bug可run~. 训测同步的重要性, 0.42涨到0.51
        img_scale=[(900, 1024), (1520, 1520)],
        flip=False,
        transforms=[
