...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1000, 1000), (1520, 1240)], keep_ratio=True),
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'train/annotations/added_Duck_inject.json',
